                ...
                <div
                    ...
                    <div class="pt-12">
                        <ul class="bg-white list-disc text-nowrap pl-8 p-3 rounded-xl">
                            ...
                            <li><a href="{{ route('visimisi') }}" class="w-full block pl-2 pr-8 py-1">Visi & Misi</a>
                            </li>
                            <li><a href="{{ route('sambutan') }}" class="w-full block pl-2 pr-8 py-1">Sambutan
                                    Rektor</a></li>
                            <li><a href="{{ route('fasilitas') }}" class="w-full block pl-2 pr-8 py-1">Fasilitas</a>
                            </li>
                        </ul>
                    </div>
                </div>
