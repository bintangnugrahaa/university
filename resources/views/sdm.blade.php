...
@section('content')
    ...
    <article class="container mt-28">
        ...
        <p class="text-xneutral-200 font-montserrat text-sm sm:text-base font-semibold">
            Faculty distinguished in their fields
        </p>
        @if ($lectures->isEmpty())
            ...
            <div class="mt-10 space-y-11">
                @foreach ($lectures as $lecture)
                    <div class="flex flex-col items-center sm:flex-row gap-8 sm:gap-16">
                        <img class="sm:col-span-2" src="{{ 'storage/' . $lecture->image }}" alt="lecturer" />
                        <div class="sm:col-span-10 font-montserrat">
                            ...
                            <table class="table-auto sm:table-fixed font-medium text-xs sm:text-sm text-xneutral-300 mt-5">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="w-24 sm:w-48 py-1">Education</td>
                                        <td class="w-4 sm:w-12">:</td>
                                        <td>
                                            {{ $lecture->pendidikan }}
                                        </td>
                                    ...
                                    <tr>
                                        <td class="w-24 sm:w-48 py-1">Position</td>
                                        <td class="w-4 sm:w-12">:</td>
                                    ...
                                    <tr>
                                        <td class="w-24 sm:w-48 py-1">Areas of Expertise</td>
                                        <td class="w-4 sm:w-12">:</td>
                                        <td>{{ $lecture->topik }}</td>
                                    </tr>
                                </tbody>
    ...
    <article class="container mt-[150px]">
        ...
        <p class="text-xneutral-200 font-montserrat text-sm sm:text-base font-semibold">
            B-University administrative team
        </p>
                    ...
                    <div class="flex flex-col items-center sm:flex-row gap-8 sm:gap-16">
                        ...
                        <div class="sm:col-span-10 font-montserrat">
                            ...
                            <table
                                ...
                                <tbody>
                                    <tr>
                                        <td class="w-24 sm:w-48 py-1">Employee ID (NIP)</td>
                                        <td class="w-4 sm:w-12">:</td>
                                        <td>{{ $admin->nip }}</td>
                                    </tr>
                                    <tr>
